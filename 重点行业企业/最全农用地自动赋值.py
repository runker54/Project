...
arcpy.CalculateField_management(NYD, nydObjectId,  "!{}!".format(nydDesc.OIDFieldName), "PYTHON_9.3")
...
arcpy.Intersect_analysis([NYD, PJDY], outputfile, "ALL", None, "LINE")
...
with arcpy.da.UpdateCursor(NYD, fields) as cursor:
	for row in cursor:
...
# arcpy.Select_analysis(NYD, outputfile, "{} < 1".format(className))
