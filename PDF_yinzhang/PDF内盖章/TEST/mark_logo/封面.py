...
for one_xz in cx_list:
    ...
    pdf_path = r'C:\Users\65680\Desktop\%s盖章后保存\%s.pdf' % (quxian, name)  # 需加盖印章的PDF
    mark_pdf = r'C:\Users\65680\Desktop\制作好\纳雍县封面.pdf'  # 水印PDF
    # out_stream = r'C:\Users\65680\Desktop\%s盖章后保存\%s.pdf' % (quxian, name)
    out_stream = r'E:\纳雍县盖章后保存\%s.pdf' % name
