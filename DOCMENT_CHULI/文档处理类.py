...
sheet_path = r"C:\Users\65680\Desktop\BT_message.xls"  # 表格位置
pingmiantu_path = r"C:\Users\65680\Desktop\BT_PMT"  # 平面图位置
xianchangtu_path = r"C:\Users\65680\Desktop\BT_XCTP\佐证图片"  # 现场图位置
diaochabiao_path = r"C:\Users\65680\Desktop\BT_DCB"  # 调查表位置
...
for one_xz in xz_list:
    ...
    for message in one_message_list:
        pass
        print(message)
        c.doc_(message)  # 写入地块说明
        c.diaochabiao()  # 写入调查表
        c.xianchang_pictures(message[0].value)  # 写入现场图片
        c.pingmianbuzhitu()  # 写入平面布置图

    c.doc_().save(r'C:\Users\65680\Desktop\DICK\%s1.docx' % one_xz)
    print(one_xz)
    time.sleep(3)
