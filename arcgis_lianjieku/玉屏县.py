...
up_sheet = r'C:\Users\65680\Desktop\玉屏连接.xlsx'

read_work = openpyxl.load_workbook(up_sheet)  # 工作簿
read_sheet = read_work.get_sheet_by_name('index_searc')  # 工作表
    ...
    for one_change in cursor:
        if one_change[12] == '':
            try:
                ...
                one_change[1] = read_sheet.cell(row_temp, 5).value  # 玉米19年
                one_change[2] = read_sheet.cell(row_temp, 6).value  # 玉米20年
                one_change[3] = read_sheet.cell(row_temp, 3).value  # 水稻19年
                one_change[4] = read_sheet.cell(row_temp, 4).value  # 水稻20年
                one_change[5] = read_sheet.cell(row_temp, 9).value    # 主要作物19年
                one_change[6] = read_sheet.cell(row_temp, 10).value  # 主要作物20年
                one_change[7] = read_sheet.cell(row_temp, 2).value  # 周边环境
                one_change[8] = 0   # 玉米19年面积
                one_change[9] = 0   # 玉米20年面积
                one_change[10] = 0   # 水稻19年面积
                one_change[11] = 0   # 水稻20年面积
