...
def sheet(x):
    ...
    ws.write_merge(8 + 5, 8 + 5, 8, 13, '%s' % sd19a, style()[0])  # 20年水稻总面积
    ws.write_merge(8 + 5, 8 + 5, 18, 22, '%s' % ym19a, style()[0])  # 20年玉米总面积
    ...
    ws.write_merge(21, 21, 18, 21, f'{sgmg}', style()[8])  # xg
    ws.write_merge(22, 22, 18, 21, '', style()[8])  # qt
    true_list = [zzjgtz, '', tghl, bgfgd, sgmg, '']
...
output_path = r'C:\Users\65680\Desktop\CK'

old_path = r'E:\台账\清镇市\清镇市\措施总表0618-SJ.xls'
